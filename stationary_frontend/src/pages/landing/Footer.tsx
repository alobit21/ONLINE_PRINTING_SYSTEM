...
export const Footer = () => {
    ...
    return (
        <footer className="bg-canvas pt-24 pb-12 text-ink border-t border-fog dark:border-charcoal transition-colors duration-300">
            <div className="section-container">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-16 mb-24">
                    ...
                    {footerLinks.map((section) => (
                        <div key={section.title}>
                            <h4 className="text-ink font-medium uppercase text-xs tracking-[0.2em] mb-8">{section.title}</h4>
                            <ul className="space-y-4">
                                {section.links.map((link) => (
                                    <li key={link.name}>
                                        <a
                                            href={link.href}
                                            className="text-charcoal hover:text-hp-primary transition-colors text-sm font-normal"
                                        >
                                            {link.name}
                                        </a>
                                    </li>
                ...
                <div className="border-t border-fog dark:border-charcoal pt-12 flex flex-col md:flex-row justify-between items-center gap-8 text-[12px] font-normal uppercase text-charcoal">
                    ...
                    <div className="flex gap-10">
                        ...
                        <a href="#" className="hover:text-hp-primary transition-colors">Security</a>
                    </div>
                </div>
            </div>
        </footer>
