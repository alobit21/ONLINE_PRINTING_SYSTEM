    ...
    return (
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-gray-900">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none -z-10">
                <div className="absolute top-[-10%] left-[10%] w-[40%] h-[40%] bg-brand-900/30 rounded-full blur-[120px] animate-pulse" />
                <div className="absolute bottom-[10%] right-[10%] w-[30%] h-[30%] bg-brand-800/40 rounded-full blur-[100px]" />
            </div>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        >
                            <div className="flex flex-col items-center lg:items-start mb-10 lg:mb-14">
                                ...
                                <h1 className="text-5xl md:text-7xl xl:text-[8rem] font-black text-white leading-[0.8] tracking-tighter uppercase mb-8">
                                ...
                                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 md:gap-5">
                                    <span className="text-xl md:text-4xl font-black text-gray-400 italic tracking-tight">Faster.</span>
                                    <div className="h-1.5 w-1.5 bg-brand-400 rounded-full opacity-50" />
                                    <span className="text-xl md:text-4xl font-black text-gray-400 italic tracking-tight">Closer.</span>
                                    <div className="h-1.5 w-1.5 bg-brand-400 rounded-full opacity-50" />
                                    <span className="text-xl md:text-4xl font-black text-white italic tracking-tight underline decoration-brand-800 decoration-8 underline-offset-4">Reliable.</span>
                                </div>
                            </div>

                            <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-semibold mb-12 max-w-[640px] mx-auto lg:mx-0">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 mb-16">
                                ...
                                <Link
                                    ...
                                    className="w-full sm:w-auto bg-gray-700 hover:bg-gray-600 text-white border-2 border-gray-600 px-10 py-5 rounded-2xl text-xl font-bold transition-all flex items-center justify-center gap-3 transform hover:scale-[1.02] hover:-translate-y-1 shadow-sm"
                                >
                                    Register Shop
                                </Link>
                            </div>

                            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-[10px] md:text-xs text-gray-500 font-black uppercase tracking-widest">
                    ...
                    <div className="flex-1 relative w-full">
                        ...
                        >
                            ...
                            <div className="relative glass p-2 lg:p-3 rounded-[2.5rem] shadow-2xl border-gray-700/40 overflow-hidden transform hover:rotate-1 transition-transform duration-700">
