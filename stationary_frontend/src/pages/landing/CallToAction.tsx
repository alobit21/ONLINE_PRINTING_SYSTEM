...
export const CallToAction = () => {
    return (
        <section className="section-padding bg-gray-800 relative overflow-hidden">
            <div className="section-container">
                <div className="gradient-brand rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-[0_64px_96px_-16px_rgba(99,102,241,0.4)]">
                    ...
                    >
                        <div className="bg-gray-900/20 backdrop-blur-md p-4 rounded-2xl w-fit mx-auto mb-10 border border-gray-700/30 rotate-12">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <Link
                                to="/register"
                                className="w-full sm:w-auto bg-gray-700 text-brand-400 hover:bg-gray-600 px-12 py-6 rounded-2xl text-2xl font-black transition-all shadow-2xl flex items-center justify-center gap-4 group transform hover:scale-[1.05] hover:-translate-y-1"
                            >
                                Upload Document
                            ...
                            <Link
                                ...
                                className="w-full sm:w-auto bg-transparent border-2 border-gray-600 text-white hover:bg-gray-700 px-12 py-6 rounded-2xl text-2xl font-black transition-all flex items-center justify-center gap-3 transform hover:scale-[1.05] hover:-translate-y-1"
                            >
                                Register Shop
                            </Link>
                        </div>
